...
public class LayoutAccessor
{
    ...
    public IEnumerable<DragablzItem> FloatingItems => _layout.FloatingDragablzItems();
    ...
    /// </summary>
    public BranchAccessor? BranchAccessor => _branchAccessor;

    /// <summary>
    /// <see cref="BranchAccessor"/> and <see cref="TabablzControl"/> are mutually exclusive, according to whether the layout has been split, or just contains a tab control.
    /// </summary>
    public TabablzControl? TabablzControl => _tabablzControl;
